...
public class ProcessMoney
{
  ...
  //Coins stored in order 1p 2p 5p 10p 20p 50p 100p 200p
  private int tempCoins[] = {0,0,0,0,0,0,0,0}; // Coins temp in the machine
  private int coinsInMachine[] = {0,0,0,0,0,0,0,0}; // Coins stored in the machine
  ...
  public void add( int coin )
  {
    ...
    switch(coin){
        ...
        case 50: tempCoins[5]++;
                 break;
        case 100: tempCoins[6]++;
                  break;
        case 200: tempCoins[7]++;
                  break;
    }
  ...
  public void cancel()
  {
    ...
    theCredit = 0;
    for (int i = 0; i<=tempCoins.length-1; i++){
        tempCoins[i]=0;
    }
  }
  ...
  {
    switch(coin){
        case 1: return coinsInMachine[0];
                
        case 2: return coinsInMachine[1];
        
        case 5: return coinsInMachine[2];
        
        case 10: return coinsInMachine[3];
        
        case 20: return coinsInMachine[4];
        
        case 50: return coinsInMachine[5];
        
        case 100: return coinsInMachine[6];
        
        case 200: return coinsInMachine[7];
    }
    return 0;
  }
}
